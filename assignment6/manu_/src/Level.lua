...
function Level:update(dt)
    ...
    if self.launchMarker.launched and not self.playerCollided and love.keyboard.wasPressed("space") and not self.playerSplit then
        self.launchMarker:splitPlayer()
